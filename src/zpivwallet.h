...
#ifndef FAC_ZFACWALLET_H
#define FAC_ZFACWALLET_H
...
public:
    ...
    void GenerateDeterministicZFAC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFAC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //FAC_ZFACWALLET_H
