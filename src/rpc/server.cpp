...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SCU features */
        {"scu", "masternode", &masternode, true, true, false},
        {"scu", "listmasternodes", &listmasternodes, true, true, false},
        {"scu", "getmasternodecount", &getmasternodecount, true, true, false},
        {"scu", "masternodeconnect", &masternodeconnect, true, true, false},
        {"scu", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"scu", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"scu", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"scu", "masternodecurrent", &masternodecurrent, true, true, false},
        {"scu", "masternodedebug", &masternodedebug, true, true, false},
        {"scu", "startmasternode", &startmasternode, true, true, false},
        {"scu", "createmasternodekey", &createmasternodekey, true, true, false},
        {"scu", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"scu", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"scu", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"scu", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"scu", "getmasternodescores", &getmasternodescores, true, true, false},
        {"scu", "mnbudget", &mnbudget, true, true, false},
        {"scu", "preparebudget", &preparebudget, true, true, false},
        {"scu", "submitbudget", &submitbudget, true, true, false},
        {"scu", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"scu", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"scu", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"scu", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"scu", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"scu", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"scu", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"scu", "checkbudgets", &checkbudgets, true, true, false},
        {"scu", "mnsync", &mnsync, true, true, false},
        {"scu", "spork", &spork, true, true, false},
        {"scu", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> scu-cli " + methodname + " " + args + "\n";
}
