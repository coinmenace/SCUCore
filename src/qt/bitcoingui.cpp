                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SCU Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SCU address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scu: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSCU"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SCU Core"), this);
    aboutAction->setStatusTip(tr("Show information about SCU Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SCU"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SCU addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SCU addresses"));
    ...
    openAction->setStatusTip(tr("Open a SCU: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SCU Core help message to get a list with possible SCU command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SCU Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SCU network", "", count));
}
...
{
    QString strTitle = tr("SCU Core"); // default title
