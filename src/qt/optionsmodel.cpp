...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SCU);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePivxAmount"))
        SoftSetArg("-anonymizefacamount", settings.value("nAnonymizePivxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in scu.cpp during shotdown to also remove the window positions
