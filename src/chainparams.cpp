...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8432;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SCU starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // SCU: 1 day
        nTargetSpacing = 1 * 60;  // SCU: 1 minute
        nMaturity = 100;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Scu Coin launches in August 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534234000;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2682532;
        ...
        **/
        assert(hashGenesisBlock == uint256("0x00000b7c773e5efa5563e5568c88844e3a60deed42b012637fd7877ed12ba9bc"));
        assert(genesis.hashMerkleRoot == uint256("0x7eb680959954521f87cd070f66acf963630921eee631c85cdc15dd3321b5a1fd"));

        vSeeds.push_back(CDNSSeedData("seed1", "seed1.securypto.io"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.securypto.io"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.securypto.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.securypto.io")); // Single node address
        vSeeds.push_back(CDNSSeedData("seed5", "seed5.securypto.io"));           // Single node address
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1534234500;
        genesis.nNonce = 3018081;
        ...
        */
        assert(hashGenesisBlock == uint256("0x0000023b09a652e60479b72fe997b67445c020d0e47c4fd2ff3708f063abd712"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.securypto.io"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.securypto.io"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.securypto.io"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.securypto.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet scu addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet scu script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet scu BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet scu BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet scu BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKeyOld = "04348C2F50F90267E64SCUC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // SCU: 1 day
        nTargetSpacing = 1 * 60;        // SCU: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1534235500;
        ...
        */
        nDefaultPort = 8435;
        assert(hashGenesisBlock == uint256("0x297a85332fb8fa24c5338d403b261ac7ce78847dc8bb637a69252759d1575d01"));
