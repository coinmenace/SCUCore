Contributing to SCU Core
============================

The SCU Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SCU Core project, and is not to be
confused with overall SCU Network Protocol consensus changes.

Whether a pull request is merged into SCU Core rests with the project merge
...
Patches that change SCU consensus rules are considerably more involved than
...
Where a patch set proposes to change the SCU consensus, it must have been
...
The project leader is the release manager for each SCU Core release.
