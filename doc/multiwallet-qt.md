...
In order to support loading of multiple wallets in scu-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is scu.cpp.
...
Changes to scu.cpp
----------------------
scu.cpp is the entry point into scu-qt, and as such, will require some minor modifications to provide hooks for
