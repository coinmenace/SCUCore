...
This mechanism has been integrated into Bitcore-Node-SCU which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SCU-Project/insight-api-scu#web-socket-api](https://github.com/SCU-Project/insight-api-scu#web-socket-api) 
* API: [https://github.com/SCU-Project/insight-api-scu#swifttx-transactions](https://github.com/SCU-Project/insight-api-scu#swifttx-transactions) 
...
By default, the SCU Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SCU Core daemon:
