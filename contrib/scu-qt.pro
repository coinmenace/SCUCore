...
RESOURCES += src/qt/scu.qrc src/qt/scu_locale.qrc

TRANSLATIONS += src/qt/locale/scu_bg.ts \
                src/qt/locale/scu_de.ts \
                src/qt/locale/scu_en.ts \
                src/qt/locale/scu_es.ts \
                src/qt/locale/scu_fi.ts \
                src/qt/locale/scu_fr.ts \
                src/qt/locale/scu_it.ts \
                src/qt/locale/scu_ja.ts \
                src/qt/locale/scu_pl.ts \
                src/qt/locale/scu_pt.ts \
                src/qt/locale/scu_ru.ts \
                src/qt/locale/scu_sk.ts \
                src/qt/locale/scu_sv.ts \
                src/qt/locale/scu_vi.ts \
                src/qt/locale/scu_zh_CN.ts \
                src/qt/locale/scu_zh_TW.ts
