...
This means one can have an always-on scud instance running, and another local scud/scu-qt instance which connects to this node and receives blocks from it.
